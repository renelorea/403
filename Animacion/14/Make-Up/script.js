...
subscribeBtn.addEventListener('click', (e) => {
    ...
    subscribeBtn.innerHTML = '<span>✓</span><span>¡Suscrito!</span>';
    subscribeBtn.style.background = '#28a745';
    emailInput.value = '';
    
    showNotification('¡Gracias por suscribirte! Recibirás nuestros mejores consejos de belleza.', 'success');
    
    // Reset button after 3 seconds
    setTimeout(() => {
        subscribeBtn.innerHTML = '<span>📧</span><span>Suscribirse</span>';
